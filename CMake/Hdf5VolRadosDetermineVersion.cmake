...
#   var_prefix : prefix for variables e.g. "HDF5_VOL_RADOS".
function(determine_version source_dir git_command var_prefix)
  if ("$Format:$" STREQUAL "")
    ...
    # this function.
    return ()
  elseif (NOT HDF5_VOL_RADOS_GIT_DESCRIBE AND
    ...
    # note, output may be set to empty if HDF5_VOL_RADOS_GIT_DESCRIBE is not defined.
    set(output "${HDF5_VOL_RADOS_GIT_DESCRIBE}")
  endif()
