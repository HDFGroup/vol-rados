...
#   include(${CTEST_SCRIPT_DIRECTORY}/hdf5_vol_rados_common.cmake)
#
...
set(CTEST_PROJECT_NAME HDF5_VOL_RADOS)
...
if(NOT DEFINED dashboard_git_url)
  set(dashboard_git_url "https://git.hdfgroup.org/scm/hdf5vol/rados-vol.git")
endif()
...
if(NOT DEFINED CTEST_SOURCE_DIRECTORY)
  if(DEFINED dashboard_source_name)
    ...
    set(CTEST_SOURCE_DIRECTORY ${CTEST_DASHBOARD_ROOT}/hdf5_vol_rados)
  endif()
endif()
...
if(EXISTS ${CTEST_SOURCE_DIRECTORY})
  ...
  if(vcs_refresh AND "${CTEST_SOURCE_DIRECTORY}" MATCHES "/hdf5_vol_rados[^/]*")
...
############################## File #######################################
  ...
  set(CTEST_DROP_LOCATION "/submit.php?project=HDF5_VOL_RADOS")
