...
#------------------------------------------------------------------------------
# Make sure it uses the same build configuration as HDF5 RADOS.
...
add_custom_command(
  OUTPUT "${HDF5_VOL_RADOS_BINARY_DIR}/Hdf5VolRadosExamples.done"
  COMMAND ${CMAKE_CTEST_COMMAND}
  ARGS ${build_config_arg}
       --build-and-test
       ${HDF5_VOL_RADOS_SOURCE_DIR}/examples
       ${HDF5_VOL_RADOS_BINARY_DIR}/examples
       --build-noclean
       --build-two-config
       --build-project Hdf5VolRadosExamples
       --build-generator ${CMAKE_GENERATOR}
       --build-makeprogram ${CMAKE_MAKE_PROGRAM}
       --build-options -DHDF5_VOL_RADOS_DIR:PATH=${HDF5_VOL_RADOS_BINARY_DIR}
  ...
  COMMAND ${CMAKE_COMMAND} -E touch
          "${HDF5_VOL_RADOS_BINARY_DIR}/Hdf5VolRadosExamples.done"
